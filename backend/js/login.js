        ...
        if (esModoLogin) {
            ...
            setTimeout(() => {
                ...
                if (rolUsuario === "alumno") {
                    window.location.replace("panel-alumno.html");
                } else if (rolUsuario === "admin") {
                    window.location.replace("admin.html");
                } else if (rolUsuario === "docente") {
                    window.location.replace("panel.html"); // Panel con navbar (Materias/Comunidad/Perfil), en /html
                } else {
                    window.location.replace("dashboard-general.html");
                }
            }, 1500);
